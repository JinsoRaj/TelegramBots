...
from modules.linkvertise import lv_bypass
...
async def start(bot, message):
    ...
    await message.reply(f'''**Hi {message.chat.first_name}!**\n'''
                        '''I'm Linkvertise.com Link Bypasser Bot.\n
        <b>Send Me Linkvertise.com Shortened Url And I Will Give You Direct Link</b>
...
async def lv_link_handler(bot, message):
