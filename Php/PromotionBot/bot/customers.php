...
$db = getDbInstance();
$select = array('id', 'f_name', 'l_name', 'created_at', 'updated_at');
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo xss_clean($row['f_name']); ?></td>
                <td><?php echo xss_clean($row['l_name']); ?></td>
                <td><?php echo xss_clean($row['created_at']); ?></td>
                <td><?php echo xss_clean($row['updated_at']); ?></td>
                <td>
